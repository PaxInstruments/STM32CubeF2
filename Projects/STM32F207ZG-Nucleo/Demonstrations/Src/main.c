...
/** @addtogroup STM32F2xx_HAL_Demonstrations
  * @{
  */
...
{ 
  ...
  /* Check the availability of adafruit 1.8" TFT shield on top of STM32NUCLEO
     board. This is done by reading the state of IO NUCLEO_ADCx_GPIO_PIN (mapped to JoyStick
...
static void TFT_DisplayMenu(void)
{
  ...
  /* Display message */
  BSP_LCD_DisplayStringAtLine(1, (uint8_t*)"   NUCLEO-F207ZG    ");
