...
USB host application based on the Mass Storage Class (MSC) on the STM32F207xx devices.

This is a typical application on how to use the STM32F207xG USB OTG Host peripheral to operate with an USB 
...
@par Directory contents
  ...
  - USB_Host/MSC_Standalone/Src/system_stm32f2xx.c      STM32F2xx system clock configuration file
  - USB_Host/MSC_Standalone/Src/stm32f2xx_it.c          Interrupt handlers
  ...
  - USB_Host/MSC_Standalone/Inc/stm32f2xx_it.h          Interrupt handlers header file
  - USB_Host/MSC_Standalone/Inc/lcd_log_conf.h          LCD log configuration file
  - USB_Host/MSC_Standalone/Inc/stm32f2xx_hal_conf.h    HAL configuration file
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics NUCLEO-207ZG Rev.B 
    boards and can be easily tailored to any other supported device and board.

  - NUCLEO-207ZG Set-up
    - Plug the USB key into the NUCLEO-207ZG board through 'USB micro A-Male 
