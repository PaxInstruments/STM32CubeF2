...
use USB device application based on the Device Firmware Upgrade (DFU) on the STM32F207xx devices.

This is a typical application on how to use the STM32F207xG USB OTG Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32F207xG devices.
...
@par Hardware and Software environment
  ...
  - NUCLEO-207ZG Set-up
    - Connect the NUCLEO-207ZG board to the PC through 'USB micro A-Male to A-Male' cable
      to the connector (CN13)
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32207_GPIO_0x8008000.dfu" provided in Binary
     directory.
