...
the HTTP server (STM3221G-EVAL) contains a html page dynamically refreshed 
...
@par Directory contents 
    ...
    - PolarSSL/SSL_Server/Inc/stm32f2xx_it.h           Interrupt handlers header file 
    - PolarSSL/SSL_Server/Inc/stm32f2xx_hal_conf.h     Library Configuration file
    ...
    - PolarSSL/SSL_Server/Src/stm32f2xx_hal_msp.c      HAL MSP module
    - PolarSSL/SSL_Server/Src/stm32f2xx_it.c           Interrupt handlers 
    - PolarSSL/SSL_Server/Src/system_stm32f2xx.c       STM32 system clock configuration file
