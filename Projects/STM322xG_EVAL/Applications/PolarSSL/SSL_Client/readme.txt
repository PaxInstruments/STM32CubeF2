...
In this application the client (STM3221G-EVAL) sends a crypted message to the 
...
@par Directory contents 
    ...
    - PolarSSL/SSL_Client/Inc/stm32f2xx_it.h           Interrupt handlers header file 
    - PolarSSL/SSL_Client/Inc/stm32f2xx_hal_conf.h     Library Configuration file
    ...
    - PolarSSL/SSL_Client/Src/stm32f2xx_hal_msp.c      HAL MSP module
    - PolarSSL/SSL_Client/Src/stm32f2xx_it.c           Interrupt handlers 
    - PolarSSL/SSL_Client/Src/system_stm32f2xx.c       STM32 system clock configuration file


@par Hardware and Software environment  

  - This application runs on STM32F217xx Devices.
  
  - This application has been tested with the following environments: 
     - STM3221G-EVAL board RevB
     - ssl_server.exe: PC utility is used as SSL server application
        This utility is provided within STM32CubeF2 package under "/Utilities/PC_Software/ssl_server"
     - DHCP server: PC utility TFTPD32 (http://tftpd32.jounin.net/) is used as a DHCP server 
     - HyperTerminal: used to display debug messages
  
  - STM3221G-EVAL Set-up 
    - Connect STM3221G-EVAL board to remote PC (through a crossover ethernet cable)
