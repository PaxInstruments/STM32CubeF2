...
in the STM32F2xx devices using the OTG-USB and UART peripherals.

This is a typical application on how to use the STM32F2xx USB OTG Device peripheral where the STM32 MCU
...
To run this application, the user can use one of the following configurations:
 ...
 - Configuration 2: 
   Connect USB cable to Host and connect UART TX pin to UART RX pin on the STM322xG-EVAL board
...
@par Directory contents 
  ...
  - USB_Device/CDC_Standalone/Src/system_stm32f2xx.c      STM32F2xx system clock configuration file
  - USB_Device/CDC_Standalone/Src/stm32f2xx_it.c          Interrupt handlers
  - USB_Device/CDC_Standalone/Src/stm32f2xx_hal_msp.c     HAL MSP module
  ...
  - USB_Device/CDC_Standalone/Inc/stm32f2xx_it.h          Interrupt handlers header file
  - USB_Device/CDC_Standalone/Inc/stm32f2xx_hal_conf.h    HAL configuration file
...
@par Hardware and Software environment
  ...
  - STM322xG-EVAL Set-up
    ...
    - Connect the STM322xG-EVAL board to the PC (or to another evaluation board) through RS232 (USART)
