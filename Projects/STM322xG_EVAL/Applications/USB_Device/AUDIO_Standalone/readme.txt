...
(Out: Speaker/Headset) capability on the STM32F2xx devices.
...
This is a typical application on how to use the STM32F2xx USB OTG Device peripheral and I2S peripheral to 
stream audio data from USB Host to the audio codec implemented on the STM322xG-EVAL board.
...
@par Directory contents
  ...
  - USB_Device/AUDIO_Standalone/Src/system_stm32f2xx.c      STM32F2xx system clock configuration file
  - USB_Device/AUDIO_Standalone/Src/stm32f2xx_it.c          Interrupt handlers
  ...
  - USB_Device/AUDIO_Standalone/Inc/stm32f2xx_it.h          Interrupt handlers header file
  - USB_Device/AUDIO_Standalone/Inc/stm32f2xx_hal_conf.h    HAL configuration file
...
@par Hardware and Software environment
  ...
  - STM322xG-EVAL Set-up
    - Connect the STM322xG-EVAL board to the PC for audio streaming through 
