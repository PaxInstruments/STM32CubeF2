...
USB device application based on the STM32F2xx multi core support feature integrating Mass Storage (MSC) 
and Human Interface (HID) in the same project.

This is a typical application on how to use the STM32F2xx USB OTG Device peripheral, where STM32 is 
enumerated as a MSC device in the High Speed mode, and also as a HID device in the Full Speed mode,
using the native PC Host HID/MSC drivers to which the STM322xG-EVAL board is connected.
...
A new HID Mouse device is detected, and the Joystick buttons mounted on the STM322xG-EVAL board, allow
...
@par Directory contents
  ...
  - USB_Device/DualCore_Standalone/Src/system_stm32f2xx.c      STM32F2xx system clock configuration file
  - USB_Device/DualCore_Standalone/Src/stm32f2xx_it.c          Interrupt handlers
  ...
  - USB_Device/DualCore_Standalone/Inc/stm32f2xx_it.h          Interrupt handlers header file
  - USB_Device/DualCore_Standalone/Inc/stm32f2xx_hal_conf.h    HAL configuration file
...
@par Hardware and Software environment
  ...
  - STM322xG-EVAL Set-up
    - Insert a microSD card into the STM322xG-EVAL uSD slot (CN6)
    - Connect the STM322xG-EVAL board to the PC through two 'USB micro A-Male 
