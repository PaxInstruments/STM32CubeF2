...
use USB device application based on the Mass Storage Class (MSC) on the STM32F2xx devices.

This is a typical application on how to use the STM32F2xx USB OTG Device peripheral to communicate with a PC
...
native PC Host MSC driver to which the STM322xG-EVAL board is connected.
...
@par Directory contents
  ...
  - USB_Device/MSC_Standalone/Src/system_stm32f2xx.c      STM32F2xx system clock configuration file
  - USB_Device/MSC_Standalone/Src/stm32f2xx_it.c          Interrupt handlers
  ...
  - USB_Device/MSC_Standalone/Inc/stm32f2xx_it.h          Interrupt handlers header file
  - USB_Device/MSC_Standalone/Inc/stm32f2xx_hal_conf.h    HAL configuration file
