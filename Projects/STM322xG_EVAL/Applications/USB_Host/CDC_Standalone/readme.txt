...
USB host application based on the Communication Class (CDC) on the STM32F2xx devices.
...
@par Directory contents
  ...
  - USB_Host/CDC_Standalone/Src/system_stm32f2xx.c      STM32F2xx system clock configuration file
  - USB_Host/CDC_Standalone/Src/stm32f2xx_it.c          Interrupt handlers
  ...
  - USB_Host/CDC_Standalone/Inc/stm32f2xx_it.h          Interrupt handlers header file
  - USB_Host/CDC_Standalone/Inc/lcd_log_conf.h          LCD log configuration file
  - USB_Host/CDC_Standalone/Inc/stm32f2xx_hal_conf.h    HAL configuration file
...
@par Hardware and Software environment
  ...
  - STM322xG-EVAL Set-up
    ...
    - Plug the CDC device into the STM322xG-EVAL board through 'USB micro A-Male 
